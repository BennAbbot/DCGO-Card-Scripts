...
public class SelectAttackEffect : MonoBehaviourPunCallbacks
{
    ...
    public IEnumerator Activate()
    {
        ...
        if (active())
        {
            ...
            IPlayerSelection seletion = attackOwner.DequeuePlayerSelection();

            if (seletion is PermanentSelection)
            {
                _defender = null;
                bool isTurnPlayer = false;
                int targetIndex = SecurityIndex;

                PermanentSelection permanentSelection = (PermanentSelection)seletion;
                ...
                {
                    isTurnPlayer = permanentSelection.IsTurnPlayerList[0];
    ...
    public void SetAttackTarget(int playerID, bool isTurnPlayer, int permanentIndex)
    {
        ...
        selectionPlayer.QueuePlayerSelection(new PermanentSelection() { IsTurnPlayerList = isTurnPlayerList, PermanentIDList = permanentIndexList });
    }
    #endregion
}
